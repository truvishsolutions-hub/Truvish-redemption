// RedemptionHistoryDetailsPopup.jsx
...
import ShareVoucherDetails from "./ShareVoucherDetails";
...
const RedemptionHistoryDetailsPopup = ({
  item,
  onClose,
}) => {
  ...
  const [showShareSuccess, setShowShareSuccess] =
    useState(false);
  ...
  const getSavedProcessFromLocal = () => {
    ...
    try {
      ...
      console.error(
        "Failed to read redemption process locally:",
        error
      );
  ...
  return (
    <>
      ...
      {/* SUCCESS TOP MESSAGE */}
      <div
        className={`history-top-success ${
          showShareSuccess
            ? "show-history-success"
            : ""
        }`}
      >
        <div className="history-success-icon">
          ✓
        </div>
          ...
          <div className="voucher-box history-voucher-box">
            ...
            <div className="history-bottom-row">
              ...
              <div className="history-bottom-left">
                ...
                <div className="history-redeemed-success">
